...
img: "https://zhiachong.com/media/sendy-post/sendy.png"
category: "Blogging"
tags:
  - "Blogging"
  - "Best Practices"
...
5. Install a few PHP libraries and fiddle with a few settings (see the [Sendy Server Compatibility Checklist](https://sendy.zhiachong.com/_compatibility.php?i=1) for more details).
...
There are several good open-source projects out there for this - I ended up using [Cerberus](https://github.com/TedGoas/Cerberus) to get started. If you want, you can also [view my email templates](https://github.com/vzhou842/zhiachong.com/tree/master/content/emails) on Github (my blog is open source)!
